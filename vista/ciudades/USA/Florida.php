...
<header class="main-header">
        <div class="carousel">
            ...
            <img class="carousel-background" src="../../../static/img/florida/florida3.jpg" alt="Fondo 2">
    ...
    <div class="main-box">
        <div class="main-box-box">
            ...
            <div class="main-title">
                <h3>HOTEL CALÍOPE</h3>
                <h1>Paraíso Tropical en Miami Beach</h1>
            </div>
            <div class="main-txt">
        ...
        <div class="main-box-right">
            <div class="img-left">
                <img class="img-main" src="../../../static/img/florida/florida4.jpg" alt="Vista del Hotel Calíope en Miami Beach al atardecer">
            </div>
            <div class="img-right">
                <img class="img-main" src="../../../static/img/florida/florida3.jpg" alt="Piscina infinity del hotel con vista al océano Atlántico">
            </div>
        </div>
    </div>
</section>
