...
<body>
    ...
    <section class="main-center">
        ...
        <img class="carousel-background" src="../../../static/img/tortossa/tossa1.jpg" alt="Fondo 1">
        <img class="carousel-background" src="../../../static/img/tortossa/tossa2.jpg" alt="Fondo 2">
    ...
    <section class="main-main">
        <div class="main-box">
            ...
            <div class="main-box-right">
                <div class="img-left">
                    <img class="img-main" src="../../../static/img/tortossa/tossa3.jpg" alt="Vista de la muralla medieval de Tossa de Mar">
                </div>
                <div class="img-right">
                    <img class="img-main" src="../../../static/img/tortossa/tossa2.jpg" alt="Playa de Tossa de Mar con aguas turquesas">
                </div>
            </div>
        </div>
    </section>
