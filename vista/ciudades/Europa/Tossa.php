...
<header class="main-header">
        <div class="carousel">
            <img class="carousel-background" src="../../../static/img/tossa/tossa1.jpg" alt="Fondo 1">
            <img class="carousel-background" src="../../../static/img/tossa/tossa2.jpg" alt="Fondo 2">
            <img class="carousel-background" src="../../../static/img/tossa/tossa3.jpg" alt="Fondo 3">
        </div>
        ...
        <div class="main-box">
            <div class="main-box-box">
                ...
                <div class="main-title">
                    <h3>TOSSA DE MAR</h3>
                    <h1>Joyera de la Costa Brava</h1>
                </div>
                <div class="main-txt">
                    <p>Descubre el encanto medieval de Tossa de Mar, donde las murallas del siglo XII se encuentran con playas de aguas cristalinas. Nuestro hotel te ofrece vistas privilegiadas a la bahía, gastronomía mediterránea y acceso directo a calas vírgenes. La Vila Vella, único ejemplo de población medieval fortificada que aún existe en la costa catalana, te espera.</p>
            ...
            <div class="main-box-right">
                <div class="img-left">
                    <img class="img-main" src="../../../static/img/tossa/tossa3.jpg" alt="Vista de la muralla medieval de Tossa de Mar">
                </div>
                <div class="img-right">
                    <img class="img-main" src="../../../static/img/tossa/tossa2.jpg" alt="Playa de Tossa de Mar con aguas turquesas">
                </div>
            </div>
        </div>
    </section>
