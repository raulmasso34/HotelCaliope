...
if ($controller !== null) {
    ...
    // Verificar si se han obtenido los países y hacer algo con ellos<link rel="shortcut icon" href="../../../static/img/favicon_io/favicon.ico" type="image/x-icon">
    ...
    <div class="main-box">
        <div class="main-box-box">
            ...
            <div class="main-title">
                <h3>HOTEL CALÍOPE</h3>
                <h1>Refugio de Montaña en los Pirineos</h1>
            </div>
            <div class="main-txt">
        ...
        <div class="main-box-right">
            <div class="img-left">
                <img class="img-main" src="../../../static/img/europa/pirineos.jpg" alt="Vista del Hotel Calíope en los Pirineos con montañas nevadas">
            </div>
            <div class="img-right">
                <img class="img-main" src="../../../static/img/europa/pirineos2.jpg" alt="Interior acogedor del hotel con chimenea y decoración rústica">
            </div>
        </div>
    </div>
</section>
