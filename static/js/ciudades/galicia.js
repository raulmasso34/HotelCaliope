...
window.addEventListener('DOMContentLoaded', () => {
    ...
    initializeCarousel('carousel1', 'right-btn1', 'left-btn1', [
      '../../../static/img/florida/habflo2.jpg',  // Asegúrate que estas rutas son correctas
      '../../../static/img/florida/habflo1.jpg', 
      // Agrega más imágenes si es necesario
    ]);
  
    initializeCarousel('carousel2', 'right-btn2', 'left-btn2', [
      '../../../static/img/Galicia/galicia4.jpg',
      '../../../static/img/Galicia/galicia.jpg', 
      // Agrega más imágenes si es necesario
    ]);
  });
